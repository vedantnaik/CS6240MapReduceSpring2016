...
- The R script pulls the files from the output folder of the pseudo mode "outputPseudo" and the output folder of the AWS mode "outputAws"
- It takes a lot of time to knit pdf, so we created an html and converted to pdf.
- This requires that you put in all the paths wherever specified

Details about the R script:
---------------------------
- explained in the report "LinearReport.pdf"
