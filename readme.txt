...
- You will have to specify the local path where the log and output files will be downloaded in the run_aws.sh file. The places are marked with <LOCAL_PATH>
- You will have to specify your bucket name on S3 in the run_aws.sh file.  The places are marked with <BUCKET_NAME>
*** re-check ***
